...
// playlist-read-private/playlist-read-collaborative used to be needed
// for Discover's playlist scanning. Discover was replaced by sibling
// suggestions built into Create Link, which queries albums and search
// directly and never touches a playlist endpoint — so those scopes are
// no longer requested. Least privilege: don't ask for access nothing
